...
const EditCoinModal: React.FC<Props> = ({ onClose, coin, onConfirm, onDelete }) => {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-white font-bold uppercase flex items-center gap-2">
                {symbol}
                <span className="text-[10px] px-1.5 py-0.5 bg-gray-800 text-gray-400 rounded font-normal">
                  Edit
                </span>
              </div>
